...
const shared_ini_file_loader_1 = __webpack_require__(9498);
const node_fs_1 = __webpack_require__(3024);
const fromWebToken_1 = __webpack_require__(6301);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(1203)));
...
var fromTokenFile = __webpack_require__(9927);
var fromWebToken = __webpack_require__(6301);
