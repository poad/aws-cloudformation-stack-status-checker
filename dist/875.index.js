...
var tokenProviders = __webpack_require__(6341);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(6218); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(2833);
...
const bdd_1 = __webpack_require__(3521);
...
var middlewareUserAgent = __webpack_require__(6973);
...
var middlewareRetry = __webpack_require__(8834);
var smithyClient = __webpack_require__(7279);
var httpAuthSchemeProvider = __webpack_require__(6330);
var runtimeConfig = __webpack_require__(2283);
var regionConfigResolver = __webpack_require__(3140);
var protocolHttp = __webpack_require__(9526);
var schemas_0 = __webpack_require__(2073);
var errors = __webpack_require__(29);
var SSOServiceException = __webpack_require__(7227);
...
const SSOServiceException_1 = __webpack_require__(7227);
...
const runtimeConfig_shared_1 = __webpack_require__(9288);
...
const httpAuthSchemeProvider_1 = __webpack_require__(6330);
const endpointResolver_1 = __webpack_require__(4580);
const schemas_0_1 = __webpack_require__(2073);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(7146);
var httpAuthSchemes = __webpack_require__(8805);
var propertyProvider = __webpack_require__(7930);
var sharedIniFileLoader = __webpack_require__(9498);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 253).then(__webpack_require__.t.bind(__webpack_require__, 8253, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 253).then(__webpack_require__.t.bind(__webpack_require__, 8253, 23));
