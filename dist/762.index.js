...
var client = __webpack_require__(9009);
var tokenProviders = __webpack_require__(9446);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(4753); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(5784);
...
const httpAuthSchemes_1 = __webpack_require__(7268);
...
const bdd_1 = __webpack_require__(9898);
...
var middlewareUserAgent = __webpack_require__(8236);
...
var middlewareRetry = __webpack_require__(7579);
var smithyClient = __webpack_require__(3684);
var httpAuthSchemeProvider = __webpack_require__(2595);
var runtimeConfig = __webpack_require__(298);
var regionConfigResolver = __webpack_require__(3140);
var protocolHttp = __webpack_require__(9526);
var schemas_0 = __webpack_require__(7612);
var errors = __webpack_require__(3600);
var SSOServiceException = __webpack_require__(2512);
...
const SSOServiceException_1 = __webpack_require__(2512);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(6337));
const client_1 = __webpack_require__(9009);
const httpAuthSchemes_1 = __webpack_require__(7268);
const util_user_agent_node_1 = __webpack_require__(2720);
const config_resolver_1 = __webpack_require__(9785);
const hash_node_1 = __webpack_require__(4550);
const middleware_retry_1 = __webpack_require__(7579);
...
const util_retry_1 = __webpack_require__(2516);
const runtimeConfig_shared_1 = __webpack_require__(1059);
...
exports.getRuntimeConfig = void 0;
const httpAuthSchemes_1 = __webpack_require__(7268);
const protocols_1 = __webpack_require__(71);
...
const httpAuthSchemeProvider_1 = __webpack_require__(2595);
const endpointResolver_1 = __webpack_require__(7837);
const schemas_0_1 = __webpack_require__(7612);
const getRuntimeConfig = (config) => {
    return {
...
const errors_1 = __webpack_require__(3600);
const SSOServiceException_1 = __webpack_require__(2512);
...
var client = __webpack_require__(9009);
var httpAuthSchemes = __webpack_require__(7268);
var propertyProvider = __webpack_require__(7930);
var sharedIniFileLoader = __webpack_require__(9498);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 38).then(__webpack_require__.t.bind(__webpack_require__, 7038, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 38).then(__webpack_require__.t.bind(__webpack_require__, 7038, 23));
