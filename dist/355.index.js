...
const core_1 = __webpack_require__(1835);
const util_middleware_1 = __webpack_require__(6241);
...
const util_endpoints_1 = __webpack_require__(54);
const util_endpoints_2 = __webpack_require__(1738);
const ruleset_1 = __webpack_require__(7815);
...
var middlewareHostHeader = __webpack_require__(5374);
var middlewareLogger = __webpack_require__(6072);
var middlewareRecursionDetection = __webpack_require__(3738);
var middlewareUserAgent = __webpack_require__(1343);
var configResolver = __webpack_require__(4142);
var core = __webpack_require__(2934);
var middlewareContentLength = __webpack_require__(8353);
var middlewareEndpoint = __webpack_require__(2283);
var middlewareRetry = __webpack_require__(3370);
var smithyClient = __webpack_require__(5551);
var httpAuthSchemeProvider = __webpack_require__(96);
var runtimeConfig = __webpack_require__(3137);
var regionConfigResolver = __webpack_require__(7832);
var protocolHttp = __webpack_require__(3417);
var middlewareSerde = __webpack_require__(5325);
var core$1 = __webpack_require__(1835);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(3426));
const core_1 = __webpack_require__(1835);
const util_user_agent_node_1 = __webpack_require__(3611);
const config_resolver_1 = __webpack_require__(4142);
const hash_node_1 = __webpack_require__(4589);
const middleware_retry_1 = __webpack_require__(3370);
const node_config_provider_1 = __webpack_require__(396);
const node_http_handler_1 = __webpack_require__(5696);
const util_body_length_node_1 = __webpack_require__(7062);
const util_retry_1 = __webpack_require__(7165);
const runtimeConfig_shared_1 = __webpack_require__(342);
const smithy_client_1 = __webpack_require__(5551);
const util_defaults_mode_node_1 = __webpack_require__(764);
const smithy_client_2 = __webpack_require__(5551);
...
exports.getRuntimeConfig = void 0;
const core_1 = __webpack_require__(1835);
const core_2 = __webpack_require__(2934);
const smithy_client_1 = __webpack_require__(5551);
const url_parser_1 = __webpack_require__(3901);
const util_base64_1 = __webpack_require__(1532);
const util_utf8_1 = __webpack_require__(5579);
const httpAuthSchemeProvider_1 = __webpack_require__(96);
const endpointResolver_1 = __webpack_require__(8694);
const getRuntimeConfig = (config) => {
    return {
...
var protocolHttp = __webpack_require__(3417);
var core = __webpack_require__(2934);
var propertyProvider = __webpack_require__(6169);
var client = __webpack_require__(1851);
var signatureV4 = __webpack_require__(2789);
...
var propertyProvider = __webpack_require__(6169);
var sharedIniFileLoader = __webpack_require__(668);
var client = __webpack_require__(1851);
var tokenProviders = __webpack_require__(4951);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(5666); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(1583);
...
var client = __webpack_require__(1851);
var httpAuthSchemes = __webpack_require__(3766);
var propertyProvider = __webpack_require__(6169);
var sharedIniFileLoader = __webpack_require__(668);
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 625).then(__webpack_require__.t.bind(__webpack_require__, 2625, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 625).then(__webpack_require__.t.bind(__webpack_require__, 2625, 19));
