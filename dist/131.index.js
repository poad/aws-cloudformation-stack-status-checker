...
const fromWebToken_1 = __webpack_require__(9560);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(8450)));
...
var fromTokenFile = __webpack_require__(216);
var fromWebToken = __webpack_require__(9560);
