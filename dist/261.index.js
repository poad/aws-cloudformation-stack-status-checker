...
const resolveProcessCredentials = async (options, profile) => __webpack_require__.e(/* import() */ 953).then(__webpack_require__.t.bind(__webpack_require__, 6334, 19)).then(({ fromProcess }) => fromProcess({
    ...options,
    profile,
